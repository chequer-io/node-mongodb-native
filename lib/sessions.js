...
exports.commandSupportsReadConcern = exports.updateSessionFromResponse = exports.applySession = exports.TxnState = exports.ServerSessionPool = exports.ServerSession = exports.ClientSession = void 0;
const promise_provider_1 = require("./promise_provider");
const bson_1 = require("./bson");
const read_preference_1 = require("./read_preference");
const transactions_1 = require("./transactions");
Object.defineProperty(exports, "TxnState", { enumerable: true, get: function () { return transactions_1.TxnState; } });
...
class ClientSession extends mongo_types_1.TypedEventEmitter {
    ...
    constructor(topology, sessionPool, options, clientOptions) {
        ...
        this.supports = {
            causalConsistency: typeof options.causalConsistency === 'boolean' ? options.causalConsistency : true
        };
    ...
    get id() {
        var _a;
        return (_a = this.serverSession) === null || _a === void 0 ? void 0 : _a.id;
    }
    get serverSession() {
    ...
    startTransaction(options) {
        ...
        this.transaction = new transactions_1.Transaction({
            readConcern: (_b = (_a = options === null || options === void 0 ? void 0 : options.readConcern) !== null && _a !== void 0 ? _a : this.defaultTransactionOptions.readConcern) !== null && _b !== void 0 ? _b : (_c = this.clientOptions) === null || _c === void 0 ? void 0 : _c.readConcern,
            writeConcern: (_e = (_d = options === null || options === void 0 ? void 0 : options.writeConcern) !== null && _d !== void 0 ? _d : this.defaultTransactionOptions.writeConcern) !== null && _e !== void 0 ? _e : (_f = this.clientOptions) === null || _f === void 0 ? void 0 : _f.writeConcern,
            readPreference: (_h = (_g = options === null || options === void 0 ? void 0 : options.readPreference) !== null && _g !== void 0 ? _g : this.defaultTransactionOptions.readPreference) !== null && _h !== void 0 ? _h : (_j = this.clientOptions) === null || _j === void 0 ? void 0 : _j.readPreference,
            maxCommitTimeMS: (_k = options === null || options === void 0 ? void 0 : options.maxCommitTimeMS) !== null && _k !== void 0 ? _k : this.defaultTransactionOptions.maxCommitTimeMS
        });
...
function applySession(session, command, options) {
    ...
    if (session.transaction.state === transactions_1.TxnState.STARTING_TRANSACTION) {
        ...
        const readConcern = session.transaction.options.readConcern || ((_a = session === null || session === void 0 ? void 0 : session.clientOptions) === null || _a === void 0 ? void 0 : _a.readConcern);
        if (readConcern) {
